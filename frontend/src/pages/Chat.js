...
import '../App.css'
import { ReactComponent as UploadAudioIcon } from '../components/upload-audio.svg'
            ...
            {!transcript && (
                <div className="chats">
                    ...
                    <div className='chat-text'>
                        <h1>Summarize and Revoice Your <br /> Audio Instantly with AI</h1>
                        <p>Using cutting-edge AI, we turn your audio into clear summaries and revoice them in high-quality speech. Export, download, or reuse — effortlessly.</p>

                    </div>

                    <div className='chat-container' onClick={handleChooseVoice} >
                        <input
                        ...
                        >
                            <UploadAudioIcon width={'5vw'} height={'4vh'} className="logo" />
                            Choose Voice
                        </button>
                        <button className='generateButton' onClick={e => { e.stopPropagation(); handleUpload() }} disabled={loading || !file}>
